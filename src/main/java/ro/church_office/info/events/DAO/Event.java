...
public class Event {
    ...
    private Long id; private Long churchId; private Priority priority; private RecurrenceType recurrenceType;
    private String status; private EventType eventType; private String eventName; private String about; private LocalDate openDate; private LocalDate endDate;
    @ManyToOne
