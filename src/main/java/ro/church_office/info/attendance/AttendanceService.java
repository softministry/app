...
public interface AttendanceService {
    ...
    default List<AttendanceSession> registeredSessions(Long churchId) { return List.of(); }
    default List<AttendanceSession> registeredSessionsForGroup(Long churchId, Long groupId) { return List.of(); }
